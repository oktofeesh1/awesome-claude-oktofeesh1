...
installable: true
installCommand: "python bridge_mcp_ghidra.py --transport sse --mcp-host 127.0.0.1 --mcp-port 8081 --ghidra-server http://127.0.0.1:8080/"
...
clients to the Ghidra plugin's local server.
